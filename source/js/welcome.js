...
$.ajax({
    ...
    data: {
        key: 'WM4BZ-76SWV-TCWPQ-5RZPR-FUVKJ-PHFOU',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(113.362316,23.124244, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
